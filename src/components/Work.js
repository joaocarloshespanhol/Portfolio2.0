      ...
      <div className='flex flex-col lg:flex-row gap-x-8'>
        <motion.div
          ...
          <div className='group relative overflow-hidden border-2 border-white/50 rounded-xl mt-6'>
              ...
              <a href='https://lotericasaojudastadeu.com.br/'
              target='_blank'
              rel="noopener noreferrer">
              ...
              <div className='absolute -bottom-full left-12 group-hover:bottom-16 transition-all duration-700 z-50'>
                <span className='text-gradient text-[12px] lg:text-xl text-white'> www.lotericasaojudastadeu.com.br</span>
              </div></a>
        </div>
          <div className='group relative overflow-hidden border-2 border-white/50 rounded-xl mt-6'>
              <div className='group-hover:bg-black/70 w-full h-full absolute z-40 transition-all duration-300'> </div>

              <a href='https://apostandoonline.com.br/'
              target='_blank'
              rel="noopener noreferrer">
              ...
              <div className='absolute -bottom-full left-12 group-hover:bottom-16 transition-all duration-700 z-50'>
                <span className='text-gradient text-[12px] lg:text-xl text-white'> www.apostandoonline.com.br </span>
              </div></a>
        </div>
        </div>
      </motion.div>
